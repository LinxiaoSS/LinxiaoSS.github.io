...
* 2020
  ...
  ### C13 - [ISSCC'20]. A 13b 0.005mm2 40MS/s SAR ADC with kT/C Noise Cancellation
     * Jiaxin Liu, Xiyuan Tang, Wenda Zhao, **Linxiao Shen**, and Nan Sun
     * IEEE international Solid-State Circuits Conference (ISSCC), 2020, to appear (accepted)

  ### C12 - [ISSCC'20]. A 13.5b-ENOB Second-Order Noise-Shaping SAR with PVT-Robust Closed-Loop Dynamic Amplifier
     * Xiyuan Tang, Xiangxing Yang, Wenda Zhao, Chen-Kai Hsu, Jiaxin Liu, **Linxiao Shen**, Abhishek Mukherjee, Wei Shi, David Pan, and Nan Sun
     * IEEE international Solid-State Circuits Conference (ISSCC), 2020, to appear (accepted)

* 2019

  ### C11 - [ISSCC'19]. A 0.01mm2 25uW 2MS/s 74dB-SNDR Continuous-Time Pipelined-SAR ADC with 120fF Input Capacitor
  ...
  ### C10 - [VLSI sym.'19]. A 0.6-V Tail-Less Inverter Stacking Amplifier with 0.96 PEF and Chopping
  ...
  ### C9 - [ISSCC'19]. A 16fJ/conversion-step Time-Domain Incremental Zoom Capacitance-to-Digital Converter
  ...
  ### C6 - [CICC'19]. A 0.025-mm2 0.8-V 78.5dB-SNDR VCO-based Sensor Readout Circuit in a Hybrid PLL- ΔΣM Structure
  ...
  ### C5 - [CICC'19]. A 10b 100MS/s SAR ADC with Reference Ripple Cancellation
     * Xiyuan Tang, Yi Shen, **Linxiao Shen**, Wenda Zhao, Zhangming Zhu, Visvesh Sathe, and Nan Sun
     * Custom integrated circuits conference (CICC), 2019.
      
  ### C4 - [ISPD'19]. Device Layer-Aware Analytical Placement for Analog Circuits
     * Biying Xu, Shaolan Li, Chak-Wa Pui, Derong Liu, **Linxiao Shen**, Yobo Lin, Nan Sun, and David Z. Pan
     * IEEE International symposium of physical design (ISPD), 2019.
            
* 2018

  ### C3 - [ASSCC'18]. [A Second-Order Purely VCO-Based CT ΔΣ ADC using a Modified DPLL in 40nm CMOS](https://ieeexplore.ieee.org/abstract/document/8579255)
     * Yi Zhong, Shaolan Li, Arindam Sanyal, Xiyuan Tang, **Linxiao Shen**, Siliang Wu, and Nan Sun
     * IEEE Asian Solid-State Circuits Conference (A-SSCC), Tainan, 2018

* 2017
      
  ### C2 - [EMBC'17]. [NFC-Enabled, Tattoo-Like Stretchable Biosensor Manufactured by 'Cut-and-Paste' Method](https://ieeexplore.ieee.org/document/8037756)
  ...
  ### C1 - [VLSI sym.'17]. [A 1V 0.25uW Inverter-Stacking Amplifier With 1.07 Noise Efficiency Factor](https://ieeexplore.ieee.org/document/8008461)
     * **Linxiao Shen**, Nanshu Lu, and Nan Sun
